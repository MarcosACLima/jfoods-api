...
import com.dlima.jfood.domain.service.CadastroEstadoService;
...
public class EstadoController {
	...
	public ResponseEntity<Estado> atualizar(@PathVariable Long estadoId, @RequestBody Estado estado) {
		...
		// se existir
		if (estadoAtual != null) {
			BeanUtils.copyProperties(estado, estadoAtual, "id"); // ignorar o id
	...
	public ResponseEntity<?> remover(@PathVariable Long estadoId) {
		try {
			...
			return ResponseEntity.status(HttpStatus.CONFLICT).body(e.getMessage()); // conflito, tipo KEY
		}
